...
public class FirstPdf {
  ...
  private static void addMetaData(Document document) {
    ...
    document.addKeywords("Repport, UTT, uttreport, MMRecord");
...
//    	s.concat(", ");
    ...
    p3 = new Paragraph("Reporter : " + Sequence.getReporter(m.getAttendeesList()), smallBold);
    p3.setAlignment(Paragraph.ALIGN_CENTER);
    preface.add(p3);
    ...
    document.add(preface);
	  ...
	  {
		  Anchor anchor = new Anchor((String)Sequence.getQuestions(SL).get(i), catFont);
		  anchor.setName((String)Sequence.getQuestions(SL).get(i));
		  ...
		  for(int j=0;j<MINI_SL.size();j++)
		  {
			  ...
			  subCatPart.add(new Paragraph("Criteria : "+MINI_SL.get(j).getItemsList().toString()));
			  String tmpS = MINI_SL.get(j).getComment();
			  if(!tmpS.isEmpty())
				  subCatPart.add(new Paragraph("Comment : "+tmpS));
