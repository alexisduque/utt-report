...
public class RecorderActivity extends Activity implements RadioGroup.OnCheckedChangeListener{
	...
	public void addQuestion(View v)
	{
		...
		if(text.getText().toString().length()>0)
		{
	        ...
	        RadioGroup rg = (RadioGroup) findViewById(R.id.items_list_Questions);
	        LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
	        rg.addView(rb, rg.getChildCount(), lp);
			//MAJ stuff
    	...
    	if(rg1.getCheckedRadioButtonId()!=-1)
    	{
				...
				builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
				    ...
				    public void onClick(DialogInterface dialog, int which) {
			    		...
			    		{
			    			Toast.makeText(getApplicationContext(), "Forbiden Action : you can't remove the reporter!("+radioButton.getText().toString()+")", Toast.LENGTH_LONG).show();
			    		}
			    		else
			    		{
